...
export function getNav(locale?: string): NavItem[] {
  ...
  return [
    ...
    },
    {
      ...
      href: '/workflows',
      items: [
        leaf('workflows', undefined, locale),
        leaf('workflows/orchestration-primitives', undefined, locale),
        leaf('workflows/parallel-vs-pipeline', undefined, locale),
        leaf('workflows/governance-permission-cost', undefined, locale),
        leaf('workflows/bun-zig-to-rust-case', undefined, locale),
      ],
    },
    {
      type: 'category',
